    ...
    <div class="modal fade" id="modalCadastro" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body">
                <form name="formNovoEvento" method="post" action="<?= site_url('Eventos_controller/createEvento') ?> " enctype="multipart/form-data">
            ...
            <div class="container">
                ...
                <div style="width: 90%; height: 0px;">
                    ...
                    <div class="row" style="margin-top: 3%; width: 100%;">
                        ...
                        <div class="col-sm-6 col-lg-4" style="flex: 1 0 calc(100% / 3); margin-bottom: 3%;">
