            ...
            <div class="modal-body">
                <form name="formNovoEvento" method="post" action="<?= site_url('Eventos_controller/createEvento') ?> " >
                    ...
                    <div class="form-group">
                        ...
                        <div class="conjunto" style="float:right; margin-right: 7%;">
        ...
        <section class="banner_part">
            <div class="container">
                ...
                <div style="width: 90%; height: 0px;">
                    <section class="footer-area" style="background-color: transparent; padding: 0%;">
                        <div class="single-footer-widget footer_2">
                            <form method="post" action="<?= site_url('Eventos_controller/pesquisaEvento');?>">
                                <div class="divBusca input-group mb-3" style="width: 24%; border-top: none; border-right: none; border-left: none;">
                                    <input type="text" class="form-control" name="txtBusca" id="txtBusca" placeholder="Buscar..."/>
                                    <div class="input-group-append">
                                        <button type="submit" id="submit" class="btn btn_1" value="save"><img src="<?= base_url();?>assets/imagens/pesquisarIcon.png" alt=""></button>           
                                    </div>
                                </div>
                            </form>    
                        </div>
                        ...
                        <?php 
                            if($row == null){ ?>
                                <div style="text-align: center; width: 100%;">
                                    <h5 style="margin-top: 10%; padding: 11px; background-color: #f4f4f4;">Não há nenhum resultado para sua busca.</h5>
                                </div>
                        <?php }else{ ?>
                        ...
                        <div class="col-sm-6 col-lg-4" style="margin-bottom: 3%;">
                            <div class="single_special_cource">
                             <div style=" height: 260px; background-image: url(<?= base_url(); ?>assets/imagens/eventos/<?= $evento['imagem_evento'] ?>); background-position: center; background-repeat: no-repeat; background-size: cover; background-clip: content-box;" class="special_img" style="max-width: 100%;"></div>
                                <!-- <img src="?= //base_url(); ?>assets/imagens/eventos/" class="special_img" style="max-width: 100%;"> -->
                                <div class="special_cource_text">
                                    ...
                                    <div class="author_info_text">
                                        <p>Endereco:</p>
                                        <h5> Rua <?=$evento['rua'] ?>, nº <?=$evento['numero'] ?> - <?=$evento['bairro'] ?></h5>
                                    </div>
                                    <?php if($this->session->userdata('logged_in') == TRUE): 
                                             if($this->session->userdata('tip_user') === '1' or $this->session->userdata('tip_user') === '2'): ?>
